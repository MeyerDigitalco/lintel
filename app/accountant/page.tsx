        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-5 py-14 md:grid-cols-[1.05fr_0.95fr] md:gap-16 md:py-20">
          <div>
            ...
            <h1 className="display mt-5 text-[2.8rem] text-char md:text-[3.8rem]">
              ...
              <br />
              <em className="text-clay">We built you a seat.</em>
            </h1>
            ...
            <p className="mt-5 max-w-[46ch] text-[17px] leading-relaxed text-umber">
              You stop receiving a carrier bag of receipts in January. You start the year with
              categorised records, evidence attached, and a direct line to ask the client the three
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 md:py-24">
        ...
        <div className="mt-14 grid gap-16">
          {[
            ...
            {
              n: "03",
              title: "Ask the client inside the file, not over email",
              body: "A threaded query list attached to the portfolio. You ask, the landlord answers, either party marks it resolved. Next year, the reasoning behind a judgement call is still sitting next to the transaction it relates to, instead of buried in an email chain nobody can find.",
        ...
        <div className="mx-auto max-w-3xl px-5 py-16 md:py-24">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-5 max-w-[48ch] text-[18px] leading-relaxed text-umber">
              Tell us how many landlord clients you look after and we will call you back to set your
              practice up and walk you through the portal properly.
            </p>
          </div>
          <CallbackForm
