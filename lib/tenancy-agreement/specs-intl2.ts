...
export const FR_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "fr_loyer", heading: "Rent", statutory: true, basis: "Loi ALUR; loi ELAN art.140",
...
export const ES_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "es_renta", heading: "Rent", statutory: true, basis: "LAU art.17-18; Ley 12/2023",
...
export const NL_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "nl_borg", heading: "Deposit", statutory: true, basis: "Wet goed verhuurderschap 2023",
...
export const IT_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "it_deposito", heading: "Deposit", statutory: true, basis: "Legge 392/1978 art.11",
...
export const PT_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "pt_caucao", heading: "Deposit", statutory: true, basis: "Mais Habitação (Lei 56/2023)",
...
export const CH_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "ch_kaution", heading: "Deposit", statutory: true, basis: "OR art.257e",
...
export const BE_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "be_garantie", heading: "Deposit", statutory: true, basis: "Regional housing code",
...
export const AT_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "at_rent", heading: "Rent", statutory: true, basis: "MRG s.16, Richtwertgesetz",
    ...
    { id: "at_kaution", heading: "Deposit", statutory: true, basis: "MRG s.16b",
...
export const PL_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "pl_kaucja", heading: "Deposit", statutory: true, basis: "Ustawa o ochronie praw lokatorów art.6",
...
export const SA_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "sa_rent", heading: "Rent", basis: "Ejar regulations",
...
export const QA_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "qa_rent", heading: "Rent", statutory: true, basis: "Law No. 4 of 2008 art.10-12",
