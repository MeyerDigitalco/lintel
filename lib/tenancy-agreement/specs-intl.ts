...
export const IE_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "ie_deposit", heading: "Deposit", replaces: "deposit", statutory: true, basis: "Residential Tenancies Act 2004 s.12; Residential Tenancies (Amendment) Act 2021 s.6",
    ...
    { id: "ie_ending", heading: "Ending the tenancy", replaces: "ending", statutory: true, basis: "Residential Tenancies Act 2004 Part 5, s.34 and Table 1 to s.66",
...
export const AU_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "au_ending", heading: "Ending the tenancy", replaces: "ending", statutory: true, basis: "State/territory Residential Tenancies Act",
...
export const NZ_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "nz_ending", heading: "Ending the tenancy", replaces: "ending", statutory: true, basis: "Residential Tenancies Act 1986 ss.50-60A",
...
export const CA_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "ca_ending", heading: "Ending the tenancy", replaces: "ending", statutory: true, basis: "Provincial Residential Tenancies Act",
...
export const ZA_SPEC: AgreementSpec = {
  ...
  clauses: [
    ...
    { id: "za_deposit", heading: "Deposit", replaces: "deposit", statutory: true, basis: "Rental Housing Act 50 of 1999 s.5",
