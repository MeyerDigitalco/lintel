...
const MONEY_LOCALE: Record<string, string> = { GBP: "en-GB", USD: "en-US", AED: "en-AE", ZAR: "en-ZA", EUR: "en-IE", AUD: "en-AU", CAD: "en-CA", NZD: "en-NZ", INR: "en-IN", SGD: "en-SG", CHF: "de-CH", JPY: "ja-JP", MXN: "es-MX", BRL: "pt-BR" };
